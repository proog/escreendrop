namespace sharpscreendrop {
	partial class AboutDialog {
		...
		private void InitializeComponent() {
			...
			this.label1.Text = "About eScreenDrop";
			// 
			// pictureBox1
			// 
			...
			this.label2.Text = "version sharp-0.23";
			// 
			// label3
			// 
			this.label3.AutoSize = true;
			this.label3.Location = new System.Drawing.Point(174, 107);
			...
			// closeButton
			// 
			this.closeButton.Location = new System.Drawing.Point(250, 176);
			...
			this.linkLabel1.Location = new System.Drawing.Point(174, 135);
